...
import EventDetailPage from "./component/MarketPlace/Subcomponents/Events/DetailPage/EventDetailsBooking";
import GoogleSingup from "./component/Business Website/GoogleSignup/Signup";
      ...
      <Router>
        <Routes>
          ...
          {verified && role === "Superadmin" ? (
            <>
              <Route
                ...
                element={<NewSuperAdminDashboard />}
              />
              <Route
                path="/superadmin/accepotedapplication"
                element={<AcceptedApplication />}
              />
            </>
          ) : (
            <>
          ...
          {verified && role === "Admin" ? (
            <>
              <Route
                path={"/:academyname/admin/dashboard"}
                element={<NewAdminDashboard />}
              ></Route>
              <Route
                path={"/:academyname/admin/regform"}
                element={<AcademyRegistration />}
              ></Route>
              <Route
                path={"/:academyname/admin/feesdetails"}
                element={<PaymentDetails />}
              ></Route>
              <Route
                path={"/:academyname/attendance"}
                element={<AutomatedAttendance />}
              ></Route>
            </>
          ) : (
            <>
              ...
              ></Route>
              <Route
                path="/subscriptionpayment/:id"
                element={<AcademySubscriptionPayment />}
              ></Route>
              <Route
          ...
          <Route path="/onboarding" element={<GoogleSingup />} />
          ...
          <Route path="/EventBooking" element={<EventDetailPage />} />
