...
const Banners = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const url =
        "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/uploadbannerphotos";
  ...
  const handleadditiontodb = async (imageurl) => {
    const url =
      "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/addbanner";
    const token = Token();
    const response = await fetch(url, {
      method: "PUT",
      headers: {
