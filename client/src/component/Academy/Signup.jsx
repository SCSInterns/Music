...
function Signup() {
  ...
  const setacademyname = async () => {
    const url = `https://e673-2401-4900-1c80-453-9857-51b6-65f9-1434.ngrok-free.app/api/auth/preview/${id}`;
      ...
      if (!otpSent) {
        ...
        if (response.ok) {
          ...
          const signupResponse = await fetch(
            "https://e673-2401-4900-1c80-453-9857-51b6-65f9-1434.ngrok-free.app/api/auth/academysignup",
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
