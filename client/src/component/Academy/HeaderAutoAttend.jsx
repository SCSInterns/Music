        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-12 sm:px-12 lg:pt-16">
          <header className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-sm font-semibold text-gray-400">
              "Modernizing Attendance for a Connected World"
              <p> - Embrace innovation with seamless attendance tracking.</p>
            </p>
          </header>
        </div>
      </div>
...
export default HeaderAutoAttend;
