...
const ApplicantsTable = ({ users }) => {
  ...
  const handleattendancerecord = async () => {
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/getrecords";
    const token = Token();
  ...
  const paymentstats = async (studentid) => {
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/getpaymentstats";
  ...
  const addlatestpaymentdue = async (
    ...
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/addlatestdue";
    const token = Token();
    const response = await fetch(url, {
      method: "PUT",
      headers: {
  ...
  const handleinstallmentsubmition = async (id) => {
    ...
    const url = `https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/addpaymentdetails/${id}`;
  ...
  const getsubscriptiondays = async (id) => {
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/getsubscriptiondetails";
    let token = Token();
  ...
  const sendcredentialsemail = async (
    ...
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/setcredentials";
    const token = Token();
    const response = await fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePreview = async (id) => {
    const url = `https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/getdatabyid/${id}`;
    let token = Token();
  ...
  const handleinstallment = async (id) => {
    const url = `https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/updateinstallment/${id}`;
    const token = Token();
  ...
  const handleclick = async (status, id) => {
    const url = `https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/updatestatus/${id}`;
    const token = Token();
    const response = await fetch(url, {
      method: "PUT",
      headers: {
