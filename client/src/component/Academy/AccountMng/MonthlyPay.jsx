...
export default function AnalyticsPage() {
  ...
  const fetchDefaultIncome = async () => {
    const url =
      "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/fetchacademyaccount";
  ...
  const handleSubmit = async () => {
    ...
    const url =
      "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/fetchcustomstats";
