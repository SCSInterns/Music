    ...
    >
      ...
      <List sx={{ marginTop: "30px" }}>
        ...
        >
          <ListItemButton
            onClick={() =>
              navigate("/superadmin/accepotedapplication")
            }
          >
            <ListItemIcon>
              <InboxIcon />
            </ListItemIcon>
            <ListItemText primary="Accepted Request" />
          </ListItemButton>
        </ListItem>
        <ListItem
          disablePadding
        ...
        >
          <ListItemButton
            onClick={() => navigate("/superadmin/rejected-request")}
          >
            <ListItemIcon>
              <MailIcon />
            </ListItemIcon>
            <ListItemText primary="Rejected Request" />
          </ListItemButton>
        </ListItem>
      </List>
    </Box>
