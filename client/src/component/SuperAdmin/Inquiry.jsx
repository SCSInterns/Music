...
function Dashboard() {
  ...
  const setcredentials = async (id) => {
    const url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/superadmin/academycredentials/${id}`;
  ...
  const handlesharecred = async (email, id) => {
    const url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/sendcred`;
    const token = Token();
    const response = await fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlestatus = async (id, status) => {
    try {
      const url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/superadmin/academyacess/${id}`;
      const token = Token();
      const response = await fetch(url, {
        method: "PUT",
        headers: {
  ...
  const fetchadmindetailsbyid = async (id) => {
    try {
      const url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/superadmin/detailsofadminbyid/${id}`;
      const token = Token();
      const response = await fetch(url, {
        method: "GET",
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const token = Token();
        const url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/superadmin/academydetails`;
        const response = await fetch(url, {
          method: "POST",
          headers: {
            Authorization: `${token}`,
  ...
  const handlePreview = async (id, academyName) => {
    try {
      ...
      let url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/preview/${id}`;
      ...
      url = `https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/academybyname`;
