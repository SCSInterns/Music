...
function ForgotPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    const url =
      "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/send-customotp";
    try {
  ...
  const handlePasswordReset = async () => {
    ...
    if (pwdregex.test(newPassword)) {
      if (newPassword === confirmPassword) {
        const url =
          "https://ac26-2401-4900-1c80-453-791e-b7de-8205-4ba4.ngrok-free.app/api/auth/resetcred";
