...
export default function Footer() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#020617", color: "white" , fontFamily : 'ubuntu' }}
    >
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          {/* <p className="mt-4 text-sm ">
            At CastFit, we are dedicated to connecting talented individuals with
            their dream jobs, fostering growth, and empowering careers.
          </p> */}
        </div>
      </div>
