...
export default function QRPaymentPage({ data }) {
  ...
  const submitPayment = async () => {
    ...
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/submitmanualpayment";
    const token = Token();
  ...
  const fetchQR = async () => {
    const url =
      "https://5817-2401-4900-1c80-3ab2-dca7-daa1-96ff-e659.ngrok-free.app/api/auth/getqr";
